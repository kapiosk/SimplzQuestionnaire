...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplzQuestionnaire.Model.SessionGroup", b =>
                {
            ...
            modelBuilder.Entity("SimplzQuestionnaire.Model.SessionGroupUser", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.HasKey("UserId", "SessionGroupId");

                    b.HasIndex("SessionGroupId");

                    b.HasIndex("UserId", "SessionGroupId");

                    b.ToTable("SessionGroupUsers");
                });
            ...
            modelBuilder.Entity("SimplzQuestionnaire.Model.SessionGroupUser", b =>
                {
                    b.HasOne("SimplzQuestionnaire.Model.SessionGroup", null)
                        .WithMany("SessionGroupUsers")
            ...
            modelBuilder.Entity("SimplzQuestionnaire.Model.SessionGroup", b =>
                {
                    b.Navigation("SessionGroupUsers");
                });
